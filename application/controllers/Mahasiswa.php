<?php 
	...
	class Mahasiswa extends CI_Controller
	{
		...
		public function excel()
		{
			...
			$object->getProperties()->setCreator("Huda");
			$object->getProperties()->setLastModifiedBy("Huda");
			$object->getProperties()->setTitle("Export Excel");
			...
			$object->getActiveSheet()->setCellValue('H1', 'NO. TELPHONE');
